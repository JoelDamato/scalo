...
import { knowledgeBaseSections, KBSection, KBField } from '@/data/knowledgeBaseTemplates';
...
export function ProjectKnowledgeBase({ projectId }: ProjectKnowledgeBaseProps) {
  ...
  // Select template based on initiative product type
  const sections = useMemo(() => {
    const hasAutomation = initiatives.some(i => i.product_type === 'automation');
    return hasAutomation ? automationKnowledgeBaseSections : knowledgeBaseSections;
  }, [initiatives]);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Información operativa del negocio del cliente.
          </p>
        </div>
        {hasChanges && (
